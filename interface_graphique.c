...
void affichage_menu (int menu)
{
	switch (menu)
	{
		...
		case (3):
		{
			...
			niveau = TTF_RenderText_Blended(fontMenu,"Quel est le niveau des IA ?",fontPurple);
			niveau_premier_IA = TTF_RenderText_Blended(fontMenu,"Premiere IA :          1          2",fontPurple);
			niveau_deuxieme_IA = TTF_RenderText_Blended(fontMenu,"Deuxieme IA :          1          2",fontPurple);
			retour = TTF_RenderText_Blended(fontMenu,"Retour",fontPurple);
